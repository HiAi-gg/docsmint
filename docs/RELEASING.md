...
mean the remote is down. Hosted Cloud authorization and client-connection methods
are documented at `https://docsmint.com/mcp/connect`. Browser consent binds access
to the selected workspace, optional category, and scopes. API-key clients retain
