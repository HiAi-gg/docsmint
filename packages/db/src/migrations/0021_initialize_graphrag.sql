...
ALTER DEFAULT PRIVILEGES FOR ROLE aiuser IN SCHEMA docs_graph GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO hiai_app;--> statement-breakpoint
ALTER DEFAULT PRIVILEGES FOR ROLE aiuser IN SCHEMA docs_graph GRANT USAGE, SELECT, UPDATE ON SEQUENCES TO hiai_app;
