...
test('all published and workspace release metadata reports 0.8.3', async () => {
  for (const path of [
    'package.json',
    'package.public.json',
...
test('workspace and public package metadata share the 0.8.3 product identity', async () => {
