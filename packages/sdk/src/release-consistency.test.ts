...
test('all published and workspace release metadata reports 0.6.3', async () => {
  for (const path of [
    'package.public.json',
...
test('workspace and public package metadata share the 0.6.3 product identity', async () => {
