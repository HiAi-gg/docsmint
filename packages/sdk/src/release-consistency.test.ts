...
test('all published and workspace release metadata reports 0.7.6', async () => {
  for (const path of [
    'package.json',
    'package.public.json',
...
test('workspace and public package metadata share the 0.7.6 product identity', async () => {
