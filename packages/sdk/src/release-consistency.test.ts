...
test('all published and workspace release metadata reports 0.7.2', async () => {
  for (const path of [
    'package.json',
    'package.public.json',
...
test('workspace and public package metadata share the 0.7.2 product identity', async () => {
