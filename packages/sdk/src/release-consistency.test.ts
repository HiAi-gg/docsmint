...
test('all published and workspace release metadata reports 0.6.2', async () => {
  for (const path of [
    'package.public.json',
...
test('workspace and public package metadata share the 0.6.2 product identity', async () => {
