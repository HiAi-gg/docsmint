  ...
  <div class="dropdown" bind:this={headingDropdownRoot}>
    ...
    {#if headingDropdownOpen}
      <div
        ...
        class:open-up={headingOpenUp}
        class:open-left={headingOpenLeft}
        role="menu"
        aria-label={m.editor_toolbar_heading()}
      >
        <button
...
{#snippet listDropdown()}
  <div class="dropdown" bind:this={listDropdownRoot}>
    ...
    {#if listDropdownOpen}
      <div
        class="dropdown-popover"
        class:open-up={listOpenUp}
        class:open-left={listOpenLeft}
        role="menu"
        aria-label={m.editor_toolbar_list()}
      >
        <button
...
{#snippet alignDropdown()}
  <div class="dropdown" bind:this={alignDropdownRoot}>
    ...
    {#if alignDropdownOpen}
      <div
        class="dropdown-popover"
        class:open-up={alignOpenUp}
        class:open-left={alignOpenLeft}
        role="menu"
        aria-label={m.editor_toolbar_align()}
      >
        <button
  ...
  <div class="highlight-picker" bind:this={highlightPickerRoot}>
    ...
    {#if highlightPickerOpen}
      <div
        ...
        class:open-up={highlightOpenUp}
        class:open-left={highlightOpenLeft}
        role="menu"
        aria-label={m.editor_toolbar_highlight()}
      >
        ...
        {#if activeHighlightColor !== null}
          <button type="button" class="highlight-clear" role="menuitem" onclick={clearHighlight}>
            {m.action_cancel()}
          </button>
        {/if}
      </div>
...
{#snippet emojiPicker()}
  <div class="emoji-picker" bind:this={emojiPickerRoot}>
    ...
    {#if emojiPickerOpen}
      <div
        class="emoji-popover"
        class:open-up={emojiOpenUp}
        class:open-left={emojiOpenLeft}
        role="menu"
        aria-label={m.editor_toolbar_emoji()}
      >
...
{#snippet tablePicker()}
  <div class="table-picker" bind:this={tablePickerRoot}>
    ...
    {#if tablePickerOpen}
      <div
        class="table-popover"
        class:table-actions-popover={tableContext.insideTable}
        class:open-up={tableOpenUp}
        class:open-left={tableOpenLeft}
        role="menu"
        aria-label={tableContext.insideTable ? 'Edit table' : 'Insert table'}
      >
        {#if tableContext.insideTable}
          <div class="table-action-group" role="group" aria-label="Rows">
            ...
            <button
              ...
              role="menuitem"
              class="table-action"
              onclick={() => runTableCommand('addRowBefore')}>Add row above</button
            >
            <button
              type="button"
              role="menuitem"
              class="table-action"
              onclick={() => runTableCommand('addRowAfter')}>Add row below</button
            >
            <button
              type="button"
              role="menuitem"
              class="table-action"
              onclick={() => runTableCommand('deleteRow')}>Delete row</button
            >
          </div>
          <div class="table-action-group" role="group" aria-label="Columns">
            ...
            <button
              ...
              role="menuitem"
              class="table-action"
              onclick={() => runTableCommand('addColumnBefore')}>Add column left</button
            >
            <button
              type="button"
              role="menuitem"
              class="table-action"
              onclick={() => runTableCommand('addColumnAfter')}>Add column right</button
            >
            <button
              type="button"
              role="menuitem"
              class="table-action"
              onclick={() => runTableCommand('deleteColumn')}>Delete column</button
            >
          </div>
          <div class="table-action-group" role="group" aria-label="Cells">
            ...
            <button
              ...
              role="menuitem"
              class="table-action"
              disabled={!tableContext.canMerge}
              onclick={() => runTableCommand('mergeCells')}>Merge selected cells</button
            >
            <button
              type="button"
              role="menuitem"
              class="table-action"
              disabled={!tableContext.canSplit}
              onclick={() => runTableCommand('splitCell')}>Split cell</button
            >
          </div>
          <div class="table-action-group table-danger-group" role="group" aria-label="Table">
            <button
              type="button"
              role="menuitem"
              class="table-action table-danger-action"
              onclick={() => runTableCommand('deleteTable')}>Delete table</button
            >
          </div>
        {:else}
...
{#if editor}
  ...
  {:else}
    <div
      ...
      style={isScrolled && floatingX !== null && floatingY !== null
        ? `position: fixed; left: ${floatingX}px; top: ${floatingY}px; bottom: auto; transform: none; touch-action: none;`
        : ''}
    ...
    >
      {#if minimal}
        <div class="floating-toolbar-row flex items-center gap-1.5 w-full">
          {#if isScrolled}
            <div
              class="flex items-center gap-1 text-muted-foreground mr-1"
      ...
      {:else if isScrolled}
        ...
        <div class="floating-toolbar-layout flex flex-col gap-1.5 w-full max-w-full">
          ...
          <div
            class="floating-toolbar-row floating-toolbar-row-secondary flex items-center gap-1.5 w-full pl-6"
          >
...
<style>
  ...
  @media (max-width: 640px) {
    ...
    .toolbar.floating-bar .dropdown-popover,
    .toolbar.floating-bar .highlight-popover,
    .toolbar.floating-bar .emoji-popover,
    .toolbar.floating-bar .table-popover {
      top: auto;
      bottom: calc(100% + 8px);
