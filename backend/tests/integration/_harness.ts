...
mock.module("../../src/lib/config.js", () => ({
	config: {
		...
		EMBEDDING_FALLBACK_2_BASE_URL: "",
		EMBEDDING_FALLBACK_2_API_KEY: "",
		EMBEDDING_FALLBACK_2_MODEL: "",
		...
		GRAPH_EXTRACT_FALLBACK_2_BASE_URL: undefined,
		GRAPH_EXTRACT_FALLBACK_2_API_KEY: undefined,
		GRAPH_EXTRACT_FALLBACK_2_MODEL: undefined,
